...
import ee.ria.DigiDoc.fragment.screen.AuthenticationIdentificationScreen
...
@Composable
fun AuthenticationIdentificationFragment(
    ...
    Surface(
        modifier =
            modifier
                ...
                }.testTag("authenticationIdentificationFragment"),
...
@Composable
fun AuthenticationIdentificationFragmentPreview() {
    RIADigiDocTheme {
